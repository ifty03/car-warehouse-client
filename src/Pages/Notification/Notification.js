  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="w-5/6 mx-auto py-10">
        ...
        <div
          className="flex items-center  justify-between gap-4 p-4 text-red-600 border rounded border-green-900/10 bg-green-50"
          role="alert"
        >
          <div className="flex items-center gap-4">
            <span className="p-2 text-white bg-red-500 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
                fill="none"
