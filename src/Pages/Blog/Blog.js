...
const Blog = () => {
  return (
    <div className="h-min-screen bg-gray-50">
      ...
      <section class="bg-gray-100 w-11/12 mx-auto rounded-lg">
          ...
          <div class="items-center lg:flex">
            <div class="lg:w-1/2">
              ...
              <p class="mt-4 text-gray-800 lg:max-w-md">
                Javascript is a High level programming language. Whereas node js
                is javascript runtime and javascript framework.JavaScript is
                normally used for any client-side activity for one web
                application.whereas node js used in backend, node js running any
                operating system for non-blocking operation.JavaScript running
                any engine like Spider monkey (FireFox), JavaScript Core
                (Safari), V8 (Google Chrome).but node js run only v8 engine.
              </p>
      ...
      <section class="bg-gray-100 w-11/12 mx-auto rounded-lg my-5">
        <div class="container px-6 py-8 mx-auto">
          <div class="items-center lg:flex">
            <div class="lg:w-1/2">
              <h2 class="text-3xl font-bold text-gray-800">
              ...
              <p class="mt-4 text-gray-800 lg:max-w-md">
                ...
                then you can use nodejs. when we create traditional web sites
                and back-end API services then we use node js. <br />
                <strong>When we use mongodb :</strong>
                MongoDB is a well-established, non-relational database system.
                when we need flexibility and horizontal scalability then we use
                mongodb
              </p>
          ...
          <div class="items-center lg:flex">
            <div class="lg:w-1/2">
              ...
              <p class="mt-4 text-gray-800 lg:max-w-md">
                ...
                hierarchical data storage 4. SQL database is Vertically Scalable
                4. nosql database is Horizontally scalable
              </p>
          ...
          <div class="items-center lg:flex">
            <div class="lg:w-1/2">
              ...
              <p class="mt-4 text-gray-800 lg:max-w-md">
                ...
                using a cryptographic algorithm. server does not need to keep a
                database with the information needed to identify the user. So
                that's what we use in our application jwt.
              </p>
