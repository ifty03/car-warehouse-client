...
const SideBar = () => {
  return (
    <div class="flex flex-col lg:w-64 md:58 w-full mx-auto h-screen px-4 py-8 bg-gray-100 border-r">
      ...
      <div class="relative mt-6">
        ...
        <input
          type="text"
          class="w-full py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-md  focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring"
          placeholder="Search"
        />
      </div>
