        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-11/12 mx-auto">
          <div>
            ...
            <p className="mt-3 text-lg text-coolGray-600">
              ...
              electric vehicles, battery energy storage and related products and
              services
            </p>
            <div className="mt-12 space-y-12">
              <div className="flex">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center w-12 h-12 rounded-md bg-violet-600 text-coolGray-50">
                    <svg
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-coolGray-600">
                    first, this stock now tranding and we now offer you 20% off
                  </p>
                </div>
              </div>
              <div className="flex">
