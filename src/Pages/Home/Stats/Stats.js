...
const Stats = () => {
  return (
    <div>
      <section className="w-5/6 bg-gray-100 mx-auto my-6 md:p-8 text-coolGray-800">
        <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
          <div className="flex overflow-hidden rounded-lg bg-coolGray-50 text-coolGray-800">
            <div className="flex items-center justify-center px-4 bg-violet-600 text-coolGray-100">
              <svg
